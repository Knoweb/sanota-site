                ...
                <div className="container">
                    ...
                    <div className="reality-technical-grid">
                        {[
                            ...
                            { title: "Need for modernization without disruption", image: realityTechBg, icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z"/></svg> }
                        ].map((item, index) => (
                            <motion.div 
                    ...
                    <div className="container">
                        <div className="why-grid-v5">
                            {[
                                ...
                                { title: "Digital Integration", desc: "Bringing data-driven insights to physical systems.", icon: "M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" },
